    ...
    render() {
        ...
        return (
            <div className={styles.container}>
                ...
                <IonItem className={styles.startBtn} routerLink="/train"><svg className={styles.svgNew} width="50" height="50" viewBox="0 0 63 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className={styles.newBtnText}>Start Blank Workspace</span></IonItem>
                <div className={styles.border}></div>
                <div className={styles.presetTitle}>....or Start with Preset Data :</div>
                <div className={styles.presetsCon}>
                {preset.map((x, y) => <PresetCard text={x} key={y}/>)}
                </div>
            </div>
        )
    }
